...
- **Feature name** -> read `docs/gdd/[feature].md` or matching file in `docs/gdd/`
- **Sprint number** (e.g., `sprint-3`) -> read `docs/todo/sprint-03.md` or similar
- **Milestone** -> read `docs/milestones/[name].md`
