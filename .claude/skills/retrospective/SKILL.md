...
- For sprint retrospectives: `docs/retrospectives/retro-[sprint-slug]-*.md`
  (also check `docs/todo/sprint-[N]-retrospective.md` as an alternate location)
- For milestone retrospectives: `docs/retrospectives/retro-[milestone-name]-*.md`
...
- Sprint plans: `docs/todo/`
- Milestone definitions: `docs/milestones/`
...
Read previous retrospectives (if any) from `docs/todo/` or `docs/milestones/` to check:
...
Ask: "May I write this to `docs/todo/sprint-[N]-retrospective.md`?" (or the milestone path if applicable)
