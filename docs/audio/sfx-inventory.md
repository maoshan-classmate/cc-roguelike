...
| ID | 名称 | 触发场景 | 职业 | 特征 |
|----|------|---------|------|------|
| 001 | warrior_slash | 战士挥剑 | warrior | 金属划痕，短促 |
| 002 | warrior_hit | 战士命中 | warrior | 金属碰撞，沉闷 |
| 003 | ranger_draw | 游侠拉弓 | ranger | 弦绷紧声 |
| 004 | ranger_shoot | 游侠射箭 | ranger | 破空声，高频 |
| 005 | ranger_hit | 箭矢命中 | ranger | 穿刺声 |
| 006 | mage_cast | 法师施法 | mage | 能量聚集，上升 |
| 007 | mage_orb_fly | 能量弹飞行 | mage | 持续嗡鸣（循环） |
| 008 | mage_hit | 能量弹命中 | mage | 能量爆裂 |
| 009 | cleric_cast | 牧师施法 | cleric | 神圣和弦 |
...
| ID | 名称 | 触发场景 | 特征 |
|----|------|---------|------|
| 011 | enemy_basic_attack | basic/fast 攻击 | 低沉咆哮 |
| 012 | enemy_ghost_attack | 幽灵攻击 | 空灵回响 |
| 013 | enemy_tank_attack | tank 攻击 | 沉重撞击 |
| 014 | enemy_boss_attack | Boss 攻击 | 威压感，低频 |
| 015 | enemy_boss_special | Boss 技能 | 蓄力+释放 |
| 016 | enemy_hit | 敌人受击 | 被打反馈 |
| 017 | enemy_die_basic | 普通敌人死亡 | 消散声 |
| 018 | enemy_die_ghost | 幽灵死亡 | 空灵消散 |
...
| ID | 名称 | 触发场景 | 特征 |
|----|------|---------|------|
| 025 | skill_dash | 冲刺 | 快速风声 |
| 026 | skill_shield_on | 护盾开启 | 能量护盾声 |
| 027 | skill_shield_off | 护盾关闭 | 能量消散 |
| 028 | skill_heal | 自我治疗 | 治愈音效 |
| 029 | skill_speed_on | 加速开启 | 能量注入 |
...
| ID | 名称 | 触发场景 | 特征 |
|----|------|---------|------|
| 032 | pickup_gold | 拾取金币 | 金币碰撞，明亮 |
| 033 | pickup_potion_hp | 拾取血瓶 | 液体晃动 |
| 034 | pickup_potion_mp | 拾取蓝瓶 | 魔法能量 |
| 035 | pickup_key | 拾取钥匙 | 金属碰撞 |
| 036 | pickup_weapon | 拾取武器 | 厚重装备感 |
...
| 039 | door_open | 门开启 | 石门移动 |
| 040 | stairs_down | 下楼梯 | 脚步+回响 |
| 041 | ambient_drip | 环境水滴 | 随机间隔，回响 |
| 042 | ambient_chain | 环境链条 | 金属碰撞，远距离 |
